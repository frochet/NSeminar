...
The main idea of this paper was to bring an overview of troobleshooting tools in SDNs and how they can works together. As we have explained, thanks to SDN stack, the job can be easely splitted and several tools can be used together to spot bugs.
